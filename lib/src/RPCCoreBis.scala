...
//  */
// abstract class RPCCoreBis()(implicit ec: ExecutionContext) {
//   import RPCCoreBis._
...
//             import p._
//             promise.complete(Try(Codec.read[Resp](in)))
//           }

//         case RPCCore.ReplyErr =>
//           getPending().foreach { p =>
//             val throwable = Try(Codec.read[Throwable](in)) match {
...
//   private def makeReply[T: Codec](id: Long, result: Try[T]): String = {
...
//   private def makeRPCMsg[T: Codec](
//       opCode: OpCode,
//       id: Long,
//       payload: T
//   ): String = {
//     Codec.withOutputStream { out =>
//       out.writeByte(opCode)
//       out.writeLong(id)
//       Codec.write(payload, out)
//     }
//   }

//   private def makeMsgMsg[T: Codec](opCode: OpCode, payload: T): String = {
//     Codec.withOutputStream { out =>
//       out.writeByte(opCode)
//       Codec.write(payload, out)
//     }
